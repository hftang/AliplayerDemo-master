        ...
        <TR>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
                    <TR>
                        <TD class=manageHead>当前位置：客户拜访记录管理 &gt; 客户拜访记录</TD>
                    </TR>
                    <TR>
                        <TD height=2></TD>
                    </TR>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        <td>拜访时间：</td>
                        <td>
                            <s:textfield name="visit_time" cssClass="textbox" id="visit_time"
                                         cssStyle="width: 180px"></s:textfield>
                        </td>

                        <td>拜访地点：</td>
                        <td>
                            <s:textfield name="visit_addr" cssClass="textbox" id="sChannel2"
                                         cssStyle="width: 180px"></s:textfield>
                        </td>
                    </TR>
                    <TR>
                        ...
                        <td>拜访详情 ：</td>
                        <td>
                            <s:textfield name="visit_detail" cssClass="textbox" id="sChannel2"
                                         cssStyle="width: 180px"></s:textfield>
                        </td>

                        <td>下次拜访时间：</td>
                        <td>
                            <s:textfield name="visit_nexttime" cssClass="textbox" id="visit_nexttime_id"
                                         cssStyle="width: 180px"></s:textfield>
                        </td>
                    </TR>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#visit_nexttime_id").datepick({dateFormat: 'yy-mm-dd'});
    });
