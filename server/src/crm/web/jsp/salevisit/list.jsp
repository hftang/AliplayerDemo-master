                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>拜访时间：从</TD>
                                    <TD>
                                        <s:textfield theme="simple" name="visit_time" cssStyle="WIDTH:80px"
                                                     cssClass="textbox" maxLength="50"></s:textfield>
                                    </TD>

                                    <TD>
                                        <s:textfield theme="simple" name="visit_end_time" cssStyle="WIDTH:80px"
                                                     cssClass="textbox" maxLength="50"></s:textfield>
                                    </TD>

                                    <td>
                                        <input type="submit" VALUE="筛选" class="button" id="sButton2" name="sButton2">
                                    </td>
                                </TR>
                                </TBODY>
                            </TABLE>
                            ...
                            <TABLE id=grid
                                ...
                                <s:iterator value="list">
                                    <TR
                                        ...
                                        <TD>
                                        <td><s:date name="visit_time" format="yyyy-MM-dd"></s:date></td>

                                        <TD><s:property value="visit_addr"/></TD>
                                        <TD><s:property value="visit_detail"/></TD>
                                        <td><s:date name="visit_nexttime" format="yyyy-MM-dd"></s:date></td>
