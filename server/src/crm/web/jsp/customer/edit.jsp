...
<s:form theme="simple" id="form1" name="form1" method="POST" enctype="multipart/form-data" action="customer_update" namespace="/">

    <%--放2个隐藏域  用户的id  用户的头像地址--%>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        ...
                        <s:textfield theme="simple" cssClass="textbox" cssStyle="WIDTH: 50px" maxLength="50"
                                     name="cust_name"></s:textfield>
                    ...
                    <TR>
                        ...
                        <td>固定电话 ：</td>
                        <s:textfield theme="simple" cssClass="textbox" cssStyle="WIDTH: 50px" maxLength="50"
                                     name="cust_phone"></s:textfield>
                        <td>移动电话 ：</td>
                        <s:textfield theme="simple" cssClass="textbox" cssStyle="WIDTH: 50px" maxLength="50"
                                     name="cust_mobile"></s:textfield>
                    </TR>
